...
const {doc, createSheet} = require("../auth")
...
router.post("/:title", async (req, res) => {
  try {
    ...
    if (title === "rundown") await createSheet(id, ["summary", "description", "start_date", "end_date", "start_datetime", "end_datetime", "color_background", "color_foreground"])
